...
public class FilaDatos {
    ...
    public FilaDatos(String nif, String adjudicatario, String objetoGenerico, 
            String objeto , Date fechaAdjudicacion,  String importe, 
            String proveedoresConsultados, String tipoContrato) {
        this.nif = nif;
